...
public class Board extends JFrame implements Dimensions {
	...
	public Board() {
		...
		DirectoryFileNameScan dirObj = new DirectoryFileNameScan();
		//String[] fileNames = dirObj.fileNameSearch();
		ArrayDeque fileNamesDeque = dirObj.fileNameSearch();
		System.out.println(fileNamesDeque.size());
		...
		for(int i = 0 ; i < fileNamesDeque.size() * 32; i++){
			...
			//System.out.println(fileNamesDeque.removeFirst());
			System.out.println(fileNames[i]);
		}
		
		String[] petStrings = { "Bird", "Cat", "Dog", "Rabbit", "Pig" };
		JComboBox loadGameList = new JComboBox(fileNames);
		loadGameList.setSelectedIndex(4);
		...
		startStopBtn.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				playSound("..//team7//sound//btnPlay.wav");
				if (isFirstTime) {
