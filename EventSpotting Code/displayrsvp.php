              ...
              <ul id="nav">
                ...
                <?php
                  if (isset($_SESSION['email']) ) {
                      ...
                      echo '<li class="menu1"><a href="rsvpevents.php" class="current1" id="u2">RSVP</a></li>';
                        ...
                        if($con)
                          {
                            ...
                            $result = mysql_query("SELECT e.event_name, e.city, e.description, e.time, e.street, e.zip, e.date, i.RSVP FROM event e,invites i where e.event_id='$eventId' and i.email='$email' and i.event_id = '$eventId'") or die ("Error in query: ".mysql_error());
                            if (mysql_num_rows($result) == 0)
                              ...
                              { 
                                while($row = mysql_fetch_array($result))
                                  {
                                      echo '<div class="wid980"><p class="bold font20" style="color:#FF8205;">'.$row[0] .'</p></div>';
                                      echo "<div class='wid980'><p class='font15 fontColor'>" . $row[2] . "</p></div>";
                                      echo "<div class='wid980'><p class='font15 fontColor'>" . $row[4] . "</p></div>";
                                      echo "<div class='wid980'><p class='font15 fontColor'>" . $row[1] ." - " .$row[5]. "</p></div>";
                                      echo "<div class='wid980'><p class='font15 fontColor'>" . $row[3] . "</p></div>";
                                      echo "<div class='wid980'><p class='font15 fontColor'>" . $row[6] . "</p></div>";
									  
									  echo "<div class='wid980'>";
										echo "<p class='font15 fontColor'> RSVP : ";
										if($row[7] == NULL){
										...
										echo "</p>";
										echo "<form name='rsvp' action='rsvp.php' method='post'>";
										echo "<select name='rsvpdecision'>
										...
										echo "<input type='submit' value='RSVP' class='searchbtn orange'/>";
									  echo "</div>";
                                  }
