                        ...
                        if($con)
                          {
                            ...
                            $result = mysql_query("SELECT e.event_name, c.category_name, e.description, i.RSVP,e.event_id FROM event e,categories c,invites i where e.category_id = c.category_id and i.event_id=e.event_id and i.email='$current_email' and e.date>NOW()") or die ("Error in query: ".mysql_error());
                            if (mysql_num_rows($result) == 0)
                              ...
                              while($row = mysql_fetch_array($result))
                                ...
                                if($count == 0)
                                  {
                                    echo '<div class="wid980 hgt25"><p class="bold font20 fontOrange"><a href="displayrsvp.php?eventId=' . $row[4] . '">' .$row[0] .'</a></p></div>';
									echo '<div class="wid980 hgt25"><p class="font15 fontColor">RSVP : ';
									if($row[3] == NULL){
