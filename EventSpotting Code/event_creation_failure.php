  ...
  ?>
    ...
    <div class="mc_landingpage_area">
      <div class="maincontent">
          ...
          <div id="mainnavWrap" >
            ...
            <div class="mid dbfl">
              <ul id="nav">
                ...
                <li class="menu1"><a href="create_event.php" class="current1" id="u3"> Create Events</a></li>
                <li class="menu1" ><a href="rsvpevents.php" id="u4"> RSVP</a></li>
                <li class="menu1"><a href="myevents.php" id="u2">My Events</a></li>
                <li class="menu1"><a href="myinterests.php" id="u2">My Interests</a></li>
              </ul>
            </div>
        ...
        <div class="wid980 adv_search_rgt">
                 <?php
                    echo "<div class='wid980 hgt25'><p class='font15' style='color:BLACK;'><i>Event could not be created</i></p></div>";
                  ?>
          </div>
        </div>
        </div>
